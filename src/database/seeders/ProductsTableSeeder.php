...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => '<img src = "storage/img/kiwi.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => '<img src = "storage/img/strawberry.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => '<img src = "storage/img/orange.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => '<img src = "storage/img/watermelon.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => '<img src = "storage/img/peach.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => '<img src = "storage/img/muscat.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => '<img src = "storage/img/pineapple.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => 1100,
            'image' => '<img src = "storage/img/grapes.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => '<img src = "storage/img/banana.png" alt = "（準備中）">',
        ...
        $param = [
            'name' => 'メロン',
            'price' => 900,
            'image' => '<img src = "storage/img/melon.png" alt = "（準備中）">',
